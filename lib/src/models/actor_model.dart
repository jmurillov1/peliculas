...
class Actor {
  ...
  Actor.fromJsonMap(Map<String, dynamic> jsonActor) {
    adult = jsonActor['adult'];
    gender = jsonActor['gender'];
    id = jsonActor['id'];
    knownForDepartment = jsonActor['known_for_department'];
    name = jsonActor['name'];
    originalName = jsonActor['original_name'];
    popularity = jsonActor['popularity'];
